        ...
        <div class="row">
            <div class="col-xl-10 offset-xl-1">
                ...
                <p class="lead text-light fw-bold" 
                   ...
                   VIP Camp Pilihan di Kampung Inggris Pare
                </p>
            </div>
        </div>
    </div>
...
<div class="feature-section">
  ...
  <div class="pricing-section">
    <h2 class="title">Dormitory VIP</h2>
    ...
    <div class="pricing-table-container">
      ...
      <p class="note">
        Harga sudah termasuk fasilitas eksklusif untuk tipe VIP selama durasi yang dipilih.
      </p>
    </div>
  </div>
    ...
    <div class="button-wrapper">
        <a href="{{ route('formulirPendaftaran', ['jenis' => 'BIE+ VIP Camp']) }}" class="booking-button">
