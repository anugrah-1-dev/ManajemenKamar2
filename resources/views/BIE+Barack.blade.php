        ...
        <div class="row">
            <div class="col-xl-10 offset-xl-1">
                ...
                <p class="lead text-light fw-bold" 
                   ...
                   Yuk, Tinggal di BIE+ Dormitory dan <br>
                   Rasakan Serunya Kampung Inggris Pare!
                </p>
            </div>
        </div>
    </div>
...
<section class="py-5">
    <div class="container text-center">
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <h2 class="fw-bold mb-3"  style="color:#0052D4;">Tinggal Lebih Nyaman di BIE+!</h2>
                <p class="lead text-muted">Rasakan pengalaman menginap luar biasa di Kamar VVIP kami!</p>
            </div>
        </div>        

        <!-- Row untuk Keunggulan Program -->
        <div class="row mt-5">
            <div class="col-md-3 text-center">
                <h1 style="font-size: 100px; margin-bottom: 25px;">🌟</h1>
                <h4 class="fw-bold" style="color:#0052D4;">Kemewahan & Kenyamanan Maksimal</h4>
                <p class="text-muted" style="line-height: 1.6;">
                    Nikmati pengalaman menginap eksklusif dengan desain interior elegan,tempat tidur premium, dan suasana yang tenang serta mewah.
                </p>
            </div>
            <div class="col-md-3 text-center">
                <h1 style="font-size: 100px; margin-bottom: 25px;">🏨</h1>
                <h4 class="fw-bold" style="color:#0052D4;">Fasilitas Eksklusif & Modern</h4>
                <p class="text-muted" style="line-height: 1.6;">
                    Dilengkapi dengan smart TV, Wi-Fi super cepat, water heater, AC, dan scurity 24 jam untuk pengalaman menginap yang tak terlupakan.
                </p>
            </div>
            <div class="col-md-3 text-center">
                <h1 style="font-size: 100px; margin-bottom: 25px;">🤵</h1>
                <h4 class="fw-bold" style="color:#0052D4;">Pelayanan Prioritas & Privasi Terjaga</h4>
                <p class="text-muted" style="line-height: 1.6;">
                    Akses eksklusif dengan check-in dan check-out cepat, layanan butler pribadi, serta keamanan dan privasi tingkat tinggi.
                </p>
            </div>
            <div class="col-md-3 text-center">
                <h1 style="font-size: 100px; margin-bottom: 25px;">🎁</h1>
                <h4 class="fw-bold" style="color:#0052D4;">Promo & Paket Istimewa</h4>
                <p class="text-muted" style="line-height: 1.6;">
                    Tersedia paket spesial dengan layanan tambahan eksklusif untuk mendukung kenyamanan dan pengalaman belajar bahasa Inggris yang lebih maksimal di kamar VVIP.
                </p>
            </div>
        </div>
    </div>
...
<section id="ProgramDormitoryIndex" style="margin-top: 200px; margin-bottom: 200px;">
    <div class="container">
        <!-- Barack Camp -->
        <div class="row align-items-center mb-5">
            <div class="col-md-6">
                <img src="https://biepluskampunginggris.com/frontend/images/foto_kamar/barack.png" alt="VVIP Camp" class="img-fluid rounded shadow"
                    style="transition: transform 0.3s ease;" onmouseover="this.style.transform='scale(1.05)'"
                    onmouseout="this.style.transform='scale(1)'" />
            </div>
            <div style="max-width: 600px; margin-left: 25px; padding: 20px;">
                <h3 style="font-weight: bold; color: #1A1A1A; margin-bottom: 10px;">Baracks Camp (Khusus Rombongan)</h3>
                <p style="color: #6C757D; font-size: 18px; line-height: 1.6; margin-bottom: 20px;">
                    Pilihan ekonomis untuk rombongan dengan fasilitas lengkap dan harga terjangkau. Cocok untuk belajar bersama teman-teman.
                </p>
                <ul style="list-style: none; padding-left: 0; margin-bottom: 20px;">
                    <li style="display: flex; align-items: center; margin-bottom: 10px;">
                        <i class="bi bi-check-circle-fill" style="color: green; font-size: 18px; margin-right: 10px;"></i>
                        <span style="color: #333; font-size: 16px;">3 Double-Deck Bed</span>
                    </li>
                    <li style="display: flex; align-items: center; margin-bottom: 10px;">
                        <i class="bi bi-check-circle-fill" style="color: green; font-size: 18px; margin-right: 10px;"></i>
                        <span style="color: #333; font-size: 16px;">AC</span>
                    </li>
                    <li style="display: flex; align-items: center; margin-bottom: 10px;">
                        <i class="bi bi-check-circle-fill" style="color: green; font-size: 18px; margin-right: 10px;"></i>
                        <span style="color: #333; font-size: 16px;">WiFi</span>
                    </li>
                    <li style="display: flex; align-items: center; margin-bottom: 10px;">
                        <i class="bi bi-check-circle-fill" style="color: green; font-size: 18px; margin-right: 10px;"></i>
                        <span style="color: #333; font-size: 16px;">Security 24 Jam</span>
                    </li>
                    <li style="display: flex; align-items: center; margin-bottom: 10px;">
                        <i class="bi bi-check-circle-fill" style="color: green; font-size: 18px; margin-right: 10px;"></i>
                        <span style="color: #333; font-size: 16px;">Area Ruangan Luas</span>
                    </li>
                </ul>
                <a href="/reservation+Barack" 
                   style="display: inline-block; background-color: #2D63E2; color: white; font-size: 18px; font-weight: bold; padding: 14px 32px; border-radius: 8px; text-decoration: none; text-align: center;
