        ...
        <div class="row">
            <div class="col-xl-10 offset-xl-1">
                ...
                <p class="lead text-light fw-bold" 
                   ...
                   VVIP Camp Pilihan di Kampung Inggris Pare
                </p>
            </div>
        </div>
    </div>
...
<div class="container">
    ...
    <div class="carousel" id="carousel">
      <div class="carousel-images" id="carouselImages">
        ...
        <img src="https://biepluskampunginggris.com/frontend/images/foto_kamar/foto-beddings.jpg" alt="2">
        ...
        <img src="https://biepluskampunginggris.com/frontend/images/foto_kamar/foto-kloset.jpg" alt="5">
        <img src="https://biepluskampunginggris.com/frontend/images/foto_kamar/water-heater.jpeg" alt="6">
        <img src="https://biepluskampunginggris.com/frontend/images/foto_kamar/shower.jpeg" alt="7">
      </div>
...
<div class="feature-section">
  ...
  <div class="pricing-section">
    <h2 class="title">Dormitory VVIP</h2>
    ...
    <div class="pricing-table-container">
      ...
      <p class="note">
        Harga sudah termasuk fasilitas eksklusif untuk tipe VVIP selama durasi yang dipilih.
      </p>
    </div>
  </div>
                ...
                <div class="card card-custom">
                    ...
                    <div class="card-body">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item border-bottom"><i class="fas fa-hot-tub me-2"></i> Pemanas Air</li>
    ...
    <div class="button-wrapper">
        <a href="{{ route('formulirPendaftaran', ['jenis' => 'BIE+ VVIP Camp']) }}" class="booking-button">
