...
<section id="ProgramDormitoryIndex" style="margin-top: 200px; margin-bottom: 200px;">
    <div class="container">
        ...
        <div class="row align-items-center mb-5">
            <div class="col-md-6">
                <img src="https://biepluskampunginggris.com/frontend/images/foto_kamar/vip.png" alt="VIP Camp" class="img-fluid rounded shadow"
            ...
            <div style="max-width: 600px; margin-left: 25px; padding: 20px;">
                <h3 style="font-weight: bold; color: #1A1A1A; margin-bottom: 10px;">VIP Camp</h3>
                <p style="color: #6C757D; font-size: 18px; line-height: 1.6; margin-bottom: 20px;">
                    Pilihan favorit dengan fasilitas modern dan kenyamanan optimal untuk pengalaman belajar yang maksimal.
                </p>
                <ul style="list-style: none; padding-left: 0; margin-bottom: 20px;">
                    <li style="display: flex; align-items: center; margin-bottom: 10px;">
                        <i class="bi bi-check-circle-fill" style="color: green; font-size: 18px; margin-right: 10px;"></i>
                        <span style="color: #333; font-size: 16px;">Double-Deck Bed</span>
                    </li>
                    <li style="display: flex; align-items: center; margin-bottom: 10px;">
                        <i class="bi bi-check-circle-fill" style="color: green; font-size: 18px; margin-right: 10px;"></i>
